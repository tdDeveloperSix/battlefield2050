            ...
            >
              ...
              >
                ...
                <div className="text-center mb-12 sm:mb-16">
                  ...
                  {section.id !== 'human-dominance' && section.id !== 'digital-integration' && section.id !== 'autonomous-assistance' && section.id !== 'hybrid-command' && section.id !== 'machine-superiority' && section.id !== 'singularity' && (
                ...
                {/* Inject per-chapter overview boxes before grid */}
                ...
                {section.id === 'human-dominance' && (
                  <div className="mt-16 space-y-8">
                    ...
                    {/* Lead-in til mini-spil (vises under afsnittet) */}
                    <p className="mt-4 text-sm text-slate-400">
                      Vil du prøve kræfter med en AI? Test din reaktionsevne i mini-spillet nedenfor.
                    </p>
                    </div>
